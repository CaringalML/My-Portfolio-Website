...
const Portfolio = () => {
  ...
  const projects = [
...

    {
      ...
      description: "A serverless Node.js/Express API built for Artisan Tiling NZ, leveraging AWS Lambda with DynamoDB integration. This API handles Inventory Management System with comprehensive logging and monitoring capabilities, deployed using Terraform and Makefile for infrastructure management.",
